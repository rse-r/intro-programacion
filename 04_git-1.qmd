...
Si usas un repositorio remoto, tendrás que agregar un paso más flujo de trabajo local (`modify --> add --> commit`) para asegurarte que la copia del repositorio en tu computadora es la misma que la copia en GitHub y vise versa. 
...
Si luego, otra persona de tu equipo hace un cambio en un archivo en su repositorio local y lo sube al repositorio remoto. Ahora, tu repositorio local está "desactualizado" respecto del repositorio remote. Necesitas descargar esos nuevos commits del repositorio remoto a tu computadora. Necesitas hacer **pull**.
