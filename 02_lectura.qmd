...
1. Escribe el código necesario para descargar los textos en español en formato .txt y guardalos en la carpeta `datos` de tu proyecto. Utiliza las url provistas en los dos listados anteriores. Piensa en nombres adecuados para tus archivos segun lo que vimos en el primer capitulo. 

2. Lee los datos descargados, para eso revisa la ayuda de la funcion `read_lines()`. 
