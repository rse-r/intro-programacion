...
[CRAN](https://cran.r-project.org), [Bioconductor](https://www.bioconductor.org) o [R-Universe](https://r-universe.dev/search) `install.packages()` va a descargar el **bundle** o el **binario** en tu computadora, 
