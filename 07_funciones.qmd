...
pulgadas_a_centimetros <- function(medida_pulgadas) {
  ...
  stopifnot(is.numeric(medida_pulgadas))
...
pulgadas_a_centimetros <- function(medida_pulgadas) {
  ...
  if (!is.numeric(medida_pulgadas)) {
    stop("medida_pulgadas debe ser numérico,\n",
         "La variable ingresada es un ", class(medida_pulgadas)[1])
  }
...
* En qué función ocurre el error
* La causa del error y cómo resolverlo.
