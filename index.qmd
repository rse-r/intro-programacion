...
A lo largo del libro, construirás un paquete de R que implementa la ley de Zipf.  

La ley de Zipf es un resultado fascinante en el campo de la lingüística cuantitativa que afirma que la segunda palabra más común en un cuerpo de texto aparece la mitad de veces que la más común, la tercera más común aparece un y así sucesivamente. Para comprobar si la ley de Zipf se cumple en una colección de textos clásicos disponibles gratuitamente en el [Proyecto Gutenberg](https://www.gutenberg.org/), escribiremos un paquete de software que cuente y analice la distribución de frecuencias de palabras en cualquier cuerpo de texto arbitrario.
