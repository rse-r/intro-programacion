...
```
La causa comun de esta nota son problemas de conectividad: R intenta conectarse a servidores de tiempo para verificar la hora actual y no puede hacerlo. Esto no es un gran problema, pero si querés resolverlo podés revisar tu conexión a internet.
